...
function updateNpcList() {
  ...
  npcs.forEach(npc => {
    ...
    if (npc.type === "mook") {
      ...
      // Display schticks (bold only the title before the colon)
...
/*===================================
  Attach Event Listeners for PCs and NPCs
===================================*/
function attachPcListeners() {
  ...
  // (Similar event listeners for backup attack, defense, toughness, speed, fortune and wound points)
...
function attachNpcListeners() {
  ...
  // (Ensure similar listeners exist for the remaining NPC stat buttons)
}
